...
The representative convergence figure is generated by:

```bash
python scripts/make_fig_convergence.py
```
The script reads result files from the results/ folder and generates:
```text
Figure1.pdf
Figure1.png
```
